(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "module", "babel-runtime/helpers/to-consumable-array", "babel-runtime/helpers/sliced-to-array", "babel-runtime/core-js/object/define-property", "babel-runtime/core-js/get-iterator", "babel-runtime/core-js/symbol", "babel-runtime/core-js/symbol/iterator", "babel-runtime/core-js/object/keys", "babel-runtime/core-js/set", "babel-runtime/core-js/promise", "babel-runtime/regenerator"], factory);
  } else if (typeof exports !== "undefined" && typeof module !== "undefined") {
    factory(exports, module, require("babel-runtime/helpers/to-consumable-array"), require("babel-runtime/helpers/sliced-to-array"), require("babel-runtime/core-js/object/define-property"), require("babel-runtime/core-js/get-iterator"), require("babel-runtime/core-js/symbol"), require("babel-runtime/core-js/symbol/iterator"), require("babel-runtime/core-js/object/keys"), require("babel-runtime/core-js/set"), require("babel-runtime/core-js/promise"), require("babel-runtime/regenerator"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global._toConsumableArray, global._slicedToArray, global._Object$defineProperty, global._getIterator, global._Symbol, global._Symbol$iterator, global._Object$keys, global._Set, global._Promise, global._regeneratorRuntime);
    global.wu = mod.exports;
  }
})(this, function (exports, module, _babelRuntimeHelpersToConsumableArray, _babelRuntimeHelpersSlicedToArray, _babelRuntimeCoreJsObjectDefineProperty, _babelRuntimeCoreJsGetIterator, _babelRuntimeCoreJsSymbol, _babelRuntimeCoreJsSymbolIterator, _babelRuntimeCoreJsObjectKeys, _babelRuntimeCoreJsSet, _babelRuntimeCoreJsPromise, _babelRuntimeRegenerator) {
  "use strict";
  ...
  module.exports = (function () {
    ...
    _babelRuntimeCoreJsObjectDefineProperty["default"](wu, "iteratorSymbol", {
      value: (function () {
        ...
        if (typeof Proxy === "function") {
          ...
          var _ret = (function () {
            ...
            try {
              ...
              try {
                for (_iterator = _babelRuntimeCoreJsGetIterator["default"](proxy); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  var _ = _step.value;
        ...
        if (typeof _babelRuntimeCoreJsSymbol["default"] === "function") {
          // && typeof Symbol.iterator === "symbol") {
          return _babelRuntimeCoreJsSymbolIterator["default"];
        }

        console.log(typeof _babelRuntimeCoreJsSymbol["default"]);
        console.log(typeof _babelRuntimeCoreJsSymbolIterator["default"]);
    ...
    function curry(fn, args) {
      return function () {
        ...
        return fn.call.apply(fn, [this].concat(_babelRuntimeHelpersToConsumableArray["default"](args), moreArgs));
      };
    }
    ...
    rewrapStaticMethod("entries", _babelRuntimeRegenerator["default"].mark(function callee$1$0(obj) {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$0$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator2 = _babelRuntimeCoreJsGetIterator["default"](_babelRuntimeCoreJsObjectKeys["default"](obj));
    ...
    rewrapStaticMethod("keys", _babelRuntimeRegenerator["default"].mark(function callee$1$1(obj) {
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$1$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            return context$2$0.delegateYield(_babelRuntimeCoreJsObjectKeys["default"](obj), "t1", 1);
    ...
    rewrapStaticMethod("values", _babelRuntimeRegenerator["default"].mark(function callee$1$2(obj) {
      var _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, k;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$2$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator3 = _babelRuntimeCoreJsGetIterator["default"](_babelRuntimeCoreJsObjectKeys["default"](obj));
    ...
    rewrapPrototypeAndStatic("cycle", _babelRuntimeRegenerator["default"].mark(function callee$1$3() {
      var saved, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$3$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            saved = [];
            ...
            context$2$0.prev = 4;
            _iterator4 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapStaticMethod("count", _babelRuntimeRegenerator["default"].mark(function callee$1$4() {
      var start = arguments[0] === undefined ? 0 : arguments[0];
      var step = arguments[1] === undefined ? 1 : arguments[1];
      var n;
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$4$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            n = start;
    ...
    rewrapStaticMethod("repeat", _babelRuntimeRegenerator["default"].mark(function callee$1$5(thing) {
      var times = arguments[1] === undefined ? Infinity : arguments[1];
      var i;
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$5$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            if (!(times === Infinity)) {
              context$2$0.next = 8;
    ...
    rewrapStaticMethod("chain", _babelRuntimeRegenerator["default"].mark(function callee$1$6() {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$6$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator5 = _babelRuntimeCoreJsGetIterator["default"](iterables);
    ...
    rewrapPrototypeAndStatic("chunk", _babelRuntimeRegenerator["default"].mark(function callee$1$7() {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$7$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            items = [];
            index = 0;
            ...
            context$2$0.prev = 5;
            _iterator6 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("concatMap", _babelRuntimeRegenerator["default"].mark(function callee$1$8(fn) {
      var _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$8$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator7 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("drop", _babelRuntimeRegenerator["default"].mark(function callee$1$9(n) {
      var i, _iteratorNormalCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$9$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            i = 0;
            ...
            context$2$0.prev = 4;
            _iterator8 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("dropWhile", _babelRuntimeRegenerator["default"].mark(function callee$1$10() {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$10$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator9 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("enumerate", _babelRuntimeRegenerator["default"].mark(function callee$1$11() {
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$11$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
    ...
    rewrapPrototypeAndStatic("filter", _babelRuntimeRegenerator["default"].mark(function callee$1$12() {
      var fn = arguments[0] === undefined ? Boolean : arguments[0];

      var _iteratorNormalCompletion10, _didIteratorError10, _iteratorError10, _iterator10, _step10, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$12$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator10 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("flatten", _babelRuntimeRegenerator["default"].mark(function callee$1$13() {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$13$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator11 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("invoke", _babelRuntimeRegenerator["default"].mark(function callee$1$14(name) {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$14$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator12 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("map", _babelRuntimeRegenerator["default"].mark(function callee$1$15(fn) {
      var _iteratorNormalCompletion13, _didIteratorError13, _iteratorError13, _iterator13, _step13, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$15$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator13 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("pluck", _babelRuntimeRegenerator["default"].mark(function callee$1$16(name) {
      var _iteratorNormalCompletion14, _didIteratorError14, _iteratorError14, _iterator14, _step14, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$16$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator14 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("reductions", _babelRuntimeRegenerator["default"].mark(function callee$1$17(fn) {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$17$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            val = initial;
            ...
            context$2$0.prev = 5;
            _iterator15 = _babelRuntimeCoreJsGetIterator["default"](this);
          ...
          case 30:
            ...
            context$2$0.prev = 33;
            _iterator16 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("reject", _babelRuntimeRegenerator["default"].mark(function callee$1$18() {
      var fn = arguments[0] === undefined ? Boolean : arguments[0];

      var _iteratorNormalCompletion17, _didIteratorError17, _iteratorError17, _iterator17, _step17, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$18$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator17 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("slice", _babelRuntimeRegenerator["default"].mark(function callee$1$19() {
      var start = arguments[0] === undefined ? 0 : arguments[0];
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$19$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            if (!(stop < start)) {
              context$2$0.next = 2;
          ...
          case 2:
            ...
            context$2$0.prev = 5;
            _iterator18 = _babelRuntimeCoreJsGetIterator["default"](this.enumerate());
          ...
          case 7:
            ...
            _step18$value = _babelRuntimeHelpersSlicedToArray["default"](_step18.value, 2);
            x = _step18$value[0];
            i = _step18$value[1];
    ...
    rewrapPrototypeAndStatic("spreadMap", _babelRuntimeRegenerator["default"].mark(function callee$1$20(fn) {
      var _iteratorNormalCompletion19, _didIteratorError19, _iteratorError19, _iterator19, _step19, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$20$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator19 = _babelRuntimeCoreJsGetIterator["default"](this);
          ...
          case 5:
            ...
            x = _step19.value;
            context$2$0.next = 9;
            return fn.apply(undefined, _babelRuntimeHelpersToConsumableArray["default"](x));
    ...
    rewrapPrototypeAndStatic("take", _babelRuntimeRegenerator["default"].mark(function callee$1$21(n) {
      var i, _iteratorNormalCompletion20, _didIteratorError20, _iteratorError20, _iterator20, _step20, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$21$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            if (!(n < 1)) {
              context$2$0.next = 2;
          ...
          case 2:
            ...
            context$2$0.prev = 6;
            _iterator20 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("takeWhile", _babelRuntimeRegenerator["default"].mark(function callee$1$22() {
      var fn = arguments[0] === undefined ? Boolean : arguments[0];

      var _iteratorNormalCompletion21, _didIteratorError21, _iteratorError21, _iterator21, _step21, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$22$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator21 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("tap", _babelRuntimeRegenerator["default"].mark(function callee$1$23() {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$23$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            context$2$0.prev = 3;
            _iterator22 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    rewrapPrototypeAndStatic("unique", _babelRuntimeRegenerator["default"].mark(function callee$1$24() {
      var seen, _iteratorNormalCompletion23, _didIteratorError23, _iteratorError23, _iterator23, _step23, x;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$24$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            seen = new _babelRuntimeCoreJsSet["default"]();
            _iteratorNormalCompletion23 = true;
            _didIteratorError23 = false;
            _iteratorError23 = undefined;
            context$2$0.prev = 4;
            _iterator23 = _babelRuntimeCoreJsGetIterator["default"](this);
    ...
    var _zip = rewrap(_babelRuntimeRegenerator["default"].mark(function callee$1$25(iterables) {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$25$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            if (iterables.length) {
              context$2$0.next = 2;
          ...
          case 6:
            ...
            context$2$0.prev = 11;
            _iterator24 = _babelRuntimeCoreJsGetIterator["default"](iters);
    ...
    rewrapStaticMethod("zip", _babelRuntimeRegenerator["default"].mark(function callee$1$26() {
      for (var _len7 = arguments.length, iterables = Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
        iterables[_key7] = arguments[_key7];
      }

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$26$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
    ...
    rewrapStaticMethod("zipLongest", _babelRuntimeRegenerator["default"].mark(function callee$1$27() {
      for (var _len8 = arguments.length, iterables = Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {
        iterables[_key8] = arguments[_key8];
      }

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$27$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
    ...
    rewrapStaticMethod("zipWith", _babelRuntimeRegenerator["default"].mark(function callee$1$28(fn) {
      ...
      return _babelRuntimeRegenerator["default"].wrap(function callee$1$28$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
    ...
    prototypeAndStatic("asyncEach", function (fn) {
      ...
      return new _babelRuntimeCoreJsPromise["default"](function (resolve, reject) {
        (function loop() {
          ...
          try {
            for (var _iterator25 = _babelRuntimeCoreJsGetIterator["default"](iter), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
              var x = _step25.value;
    ...
    prototypeAndStatic("every", function () {
      ...
      try {
        for (var _iterator26 = _babelRuntimeCoreJsGetIterator["default"](this), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
          var x = _step26.value;
    ...
    prototypeAndStatic("find", function (fn) {
      ...
      try {
        for (var _iterator27 = _babelRuntimeCoreJsGetIterator["default"](this), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
          var x = _step27.value;
    ...
    prototypeAndStatic("forEach", function (fn) {
      ...
      try {
        for (var _iterator28 = _babelRuntimeCoreJsGetIterator["default"](this), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
          var x = _step28.value;
    ...
    prototypeAndStatic("reduce", function (fn) {
      ...
      if (val === undefined) {
        ...
        try {
          for (var _iterator29 = _babelRuntimeCoreJsGetIterator["default"](this), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
            var x = _step29.value;
      ...
      try {
        for (var _iterator30 = _babelRuntimeCoreJsGetIterator["default"](this), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
          var x = _step30.value;
    ...
    prototypeAndStatic("some", function () {
      ...
      try {
        for (var _iterator31 = _babelRuntimeCoreJsGetIterator["default"](this), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
          var x = _step31.value;
    ...
    prototypeAndStatic("toArray", function () {
      return [].concat(_babelRuntimeHelpersToConsumableArray["default"](this));
    });
    ...
    var _tee = rewrap(_babelRuntimeRegenerator["default"].mark(function callee$1$29(iterator, cache) {
      var items, index, _iterator$next, done, value;

      return _babelRuntimeRegenerator["default"].wrap(function callee$1$29$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            items = cache.items;
            index = 0;
